    ...
    <div className="bg-gray-50 text-gray-800">
      ...
      {/* <section className="min-h-[80vh] flex flex-col md:flex-row items-center justify-between px-2 md:px-20 py-16 bg-white shadow-md relative">
        ...
        <div className="max-w-xl absolute left-1/3 top-1/2 -translate-x-1/2 -translate-y-1/2">
          ...
          <p className="text-lg text-gray-700 mb-6">
            An all-in-one platform to register for exams, check results, and
            stay updated with important notices from the institution.
          </p>
          <div className="flex gap-4">
            ...
            <Link
              to="/result"
              className="border border-blue-600 text-blue-600 px-6 py-3 rounded shadow hover:bg-blue-50 transition"
            >
              Check Result
            </Link>
          </div>
          ...
          {[1, 2, 3].map((id) => (
            ...
            >
              ...
              <p className="text-gray-600">
                ...
                sed lorem vitae lacus dictum lacinia.
              </p>
              <Link
                to="#"
      ...
      <section className="px-6 md:px-20 py-16 bg-white">
        ...
        <div className="max-w-4xl mx-auto text-center text-gray-700 text-lg leading-relaxed">
          Our exam registration system is built to provide a smooth and reliable
          experience for students. With real-time updates, quick registration,
          and instant result checking, students can manage their academic exams
