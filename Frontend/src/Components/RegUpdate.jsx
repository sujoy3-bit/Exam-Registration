...
const RegUpdate = () => {
  const items=[
    ...
    return(
        <section className="bg-white px-6 py-12 md:px-40 text-center">
            ...
            {items.map((item,index)=>(
                ...
                className="bg-gray-100 overflow-hidden pb-5  rounded-lg shadow-md">
                    <div className="flex items-center justify-center  mb-4 ">
                        <img  className="rounded-lg transform transition duration-300 hover:scale-105 object-fill" src="biryani.jpg" alt="" />
                    </div>
